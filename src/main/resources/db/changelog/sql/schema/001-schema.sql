...
CREATE TABLE "public"."USUARIOS_ROLES" (
	...
	CONSTRAINT URO_USUARIO_ID_FK FOREIGN KEY (URO_USUARIO_ID) REFERENCES "public"."ROLES"(ROL_ID),
	CONSTRAINT URO_ROL_ID_FK FOREIGN KEY (URO_ROL_ID) REFERENCES "public"."USUARIOS"(USU_ID)
);
-- COMENTARIOS
